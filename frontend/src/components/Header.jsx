            ...
            <div className="flex items-center space-x-4">
              ...
              {isAuthenticated ? (
                ...
                <motion.button
                  ...
                  className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold text-sm tracking-wide transition-colors flex items-center space-x-2"
                >
                  <span>Login</span>
                </motion.button>
              )}
